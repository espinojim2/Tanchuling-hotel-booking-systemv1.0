					  ...
					  <div class="form-group">
			           ...
			           <div class="form-group">
			            ...
			            <div class="col-md-8">
			              ...
			              <div class="col-md-8">
			                <input name="username" type="text" placeholder='This will serve as a user name' class="form-control input-sm" id="username" />
			              </div>
			            </div>
			       		 </div>
			  <!--     
			          ...
			          <div class="form-group">
			            ...
			            <div class="col-md-8">
			              <label class="col-md-4 control-label" for=
			              "company">COMPANY(Optional):</label>
			            ...
			            <div class="col-md-8">
			              <label class="col-md-4 control-label" for=
			              "caddress">COMPANY ADDRESS:(Optional)</label>
				...
				I <input type="checkbox" name="condition" value="checkbox" />
					...
					Your e-mail address must be valid.All your private data is confidential. We will never sell, exchange or market it in any way. For further information on the responsibilities of both parties, you may refer to us.
			    </div>
