...
<title><?php echo isset($title) ? $title . ' | Tanchuling Hotel' :  'Tanchuling Hotel' ; ?></title>
...
#site-navigation-wrap,
 ...
 #footer-wrap{ margin-left:0; margin-right:0;}
#availability-wrap{ width:100%;  margin-left:0; margin-right:0; margin-top:0;}
#site-navigation-wrap{  position:relative; z-index:10; width:100%; margin:0;}
...
#carousel-example-generic{ margin-top:-52px; margin-bottom:0px; }
 #logo{ padding:0; margin-top:-17px; margin-bottom:-30px;}
#logo img{ height:140px; width:100%; margin-bottom:-40px; }
...
.img-title-active{ padding-left:2%; padding-right:2%; background:rgba(0,0,0,0);}
#roomimg{
  padding:2%;
}
...
<body> 
 ...
 <div id="wrap" class="clr container" style='padding:0;'>
  <div id="header-wrap" >
    <header id="header" class="site-header clr">
      ...
      <div id="logo"   style=''>
          ...
          <img src="<?php echo WEB_ROOT; ?>images/banner.jpg"  title="Tanchuling Hotel" style=''>
...
==============================================================================
 -->
        ...
        <div class="row" >
            <div class="col-md-12 ">
                <div id="carousel-example-generic" style='' class="carousel slide" data-ride="carousel">
...
$str="";
$q=mysql_query("select * from  tbl_slide_img JOIN tbl_image on tbl_slide_img.imgid=tbl_image.imgid and tbl_slide_img.remark='1' order by status");
...
$str.='
                     ...
                     <div class="item '.$stat.'">
                     <img  class="img-responsive" width="100%"  style="height:400px;" src="'.WEB_ROOT.'admin/'.$img.'">
  ...
  <div id="footer" class="clr">
    <div id="footer-block-wrap" class="clr">
        <div class="span_1_of_3 col col-1 footer-block ">
          <div class='row' style='padding:2%; font-size:20px;'>
