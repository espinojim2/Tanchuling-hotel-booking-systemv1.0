...
<div id="bread">
  ...
  <div id="main" style='padding:2%;' class="site-main clr"> 
...
// ============================================================================================================================
                ...
                ?>
                 ...
                 <input type="hidden" name="ROOMPRICE" value="<?php echo $result->PRICE ;?>">
                  ...
                  <div style='' id="roomimg" class="col-sm-6 img-portfolio">
                    <div  class="wrapper clearfix">
                    <a href="#" >
                        <figure class="gallery-item " style='margin-bottom:10px;'>
   ...
   <?php
                                ...
                                $date=date("Y-m-d");
                      $q1=@mysql_query("select * from tbl_promos where remark='1' and (start_date <= '$date' and end_date >= '$date') and ROOMID='".$result->ROOMID."'");
