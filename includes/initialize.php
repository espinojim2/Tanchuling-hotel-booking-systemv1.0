...
defined('SITE_ROOT') ? null : define ('SITE_ROOT', $_SERVER['DOCUMENT_ROOT'].DS.'\a_External_Projects\Tanchuling_hotel_sysv1');   
//Ichange to depende sa pakalagay sa htdocs
//examples:
//anyfoldername\Tanchuling_hotel_sysv1
//or Tanchuling_hotel_sysv1 kung walang parent folder
