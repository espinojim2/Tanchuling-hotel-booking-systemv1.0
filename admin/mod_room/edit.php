...
<!--           <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-md-8">
              <label class="col-md-4 control-label" for=
              "PRICE">Installment Amount:</label>

              <div class="col-md-8"> 
                <input class="form-control input-sm" id="INSTALLMENT_AMOUNT" name="INSTALLMENT_AMOUNT" placeholder=
                    "Price" type="text" value="<?php echo $result->INSTALLMENT_AMOUNT; ?>" onkeyup="javascript:checkNumber(this);">
              </div>
            </div>
          </div>
