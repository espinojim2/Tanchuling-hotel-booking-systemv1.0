...
?>
        ...
        <div class="row">
            ...
            <ul class="nav nav-pills nav-stacked">
                ...
                <p><strong>Night(s): </strong><?php echo $day; ?></p>
                <p><strong>Amount: </strong><?php echo $cur->RPRICE; ?></p>
                 <p><strong>TOTAL: </strong><?php echo ($cur->RPRICE*$day); ?></p>
                <p><strong>STATUS: </strong><?php echo $cur->STATUS; ?></p>
